...
import com.android.jianchen.rentme.Adapter.SkillServiceRecyclerAdapter;
...
import com.android.jianchen.rentme.Listener.AppBarStateListener;
...
import com.android.jianchen.rentme.RestAPI.UserClient;
...
public class ProfileActivity extends AppCompatActivity implements OnServiceClickListener, OnProjectCreateListener {
    ...
    public void onServiceClick(View view, ServiceModel service) {
        ServiceDetailActivity2.navigate(this, view, this, service);
    }
